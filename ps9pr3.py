...
def process_move(p, b):
    ...
    print()
    print(b)
    if b.is_full() == True and b.is_win_for(p.checker) == False:
        print("It's a tie!")
        return True
...
class RandomPlayer(Player):
    def next_move(self, b):
        """accepts a Board object b as a parameter and returns a random column 
           where the RandomPlayer makes the next move.
        """
        self.num_moves += 1
        s = []
